 ...
 * @author Giandomenico
 */
public class UIAddVisita extends JDialog {

    public UIAddVisita(Frame frame, boolean bln) {
        super(frame, bln);
        initComponents();
     ...
     */
     public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UIAddVisita dialog = new UIAddVisita(new javax.swing.JFrame(), true);
